...
public class UserController {
    ...
    public UserVO getLoginUserInfo(HttpSession session) {
    ...
    @ApiResponses(value = { @ApiResponse(code = 200, message = "查询成功"), @ApiResponse(code = 500, message = "内部处理错误") })
    public UserVO getUserInfo(@ApiParam(name = "userId", value = "用户Id") @PathVariable String userId) {
        UserVO userVO = new UserVO();
        userVO.setUserId("gr921113");
        userVO.setNickName("edcee3000");
        return userVO;
    ...
    @ApiResponses(value = { @ApiResponse(code = 200, message = "查询成功"), @ApiResponse(code = 500, message = "内部处理错误") })
    public UserPhotosVO getUserPhotos(HttpSession session) {
    ...
    @ApiResponses(value = { @ApiResponse(code = 200, message = "查询成功"), @ApiResponse(code = 500, message = "内部处理错误") })
    public UserPhotosVO getUserPhotos(@ApiParam(name = "userId", value = "用户Id") @PathVariable String userId) {
        UserPhotosVO photosVO = new UserPhotosVO();
        photosVO.setPhotoId("12312312");
        photosVO.setNickName("edcee3000");
        photosVO.setPubDate(new Date());
    ...
    @ApiResponses(value = { @ApiResponse(code = 200, message = "查询成功"), @ApiResponse(code = 500, message = "内部处理错误") })
    public CountVO count(@ApiParam(name = "userId", value = "用户Id") @PathVariable String userId) {
